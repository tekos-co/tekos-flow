<script type="text/javascript">
  RED.nodes.registerType('tekos-waiting', {
    category: 'Dialogue',
    color: '#ffedc6',
    defaults: {
      waitingType: {
...
<script type="text/x-red" data-template-name="tekos-waiting">
  <div class="form-row">
...
<script type="text/x-red" data-help-name="tekos-waiting"><p>Set the waiting status on the chat client (something like _your_bot is typing..._).</p>
<p>Different type of wait are available: typing, recording a video, uploading a video etc (depends on the platform).</p>
