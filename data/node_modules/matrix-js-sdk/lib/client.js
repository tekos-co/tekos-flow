...
MatrixClient.prototype.createKeyBackupVersion = function (info) {
    ...
    return this._crypto._signObject(data.auth_data).then(function () {
        return _this3._http.authedRequest(undefined, "POST", "/room_keys/version", undefined, data);
    }).then(function (res) {
...
MatrixClient.prototype.startClient = function () {
    var _ref10 = (0, _bluebird.method)(function (opts) {
        var _this7 = this;
...
MatrixClient.prototype._storeClientOptions = function () {
    ...
    var serializableOpts = (0, _entries2.default)(this._clientOpts).filter(function (_ref11) {
        var _ref12 = (0, _slicedToArray3.default)(_ref11, 2),
            key = _ref12[0],
            value = _ref12[1];

        return primTypes.includes(typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value));
    }).reduce(function (obj, _ref13) {
 ...
 */
MatrixClient.prototype.doesServerSupportLazyLoading = (0, _bluebird.coroutine)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
    ...
    return _regenerator2.default.wrap(function _callee7$(_context7) {
        while (1) {
            switch (_context7.prev = _context7.next) {
                ...
                case 6:
                    return _context7.abrupt("return", this._serverSupportsLazyLoading);
