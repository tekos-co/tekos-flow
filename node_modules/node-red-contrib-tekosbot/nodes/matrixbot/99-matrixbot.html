...
<script type="text/javascript">
    RED.nodes.registerType('tekos bot',{
        category: 'config',
        color: '#a6bbcf',
        defaults: {
            name: {type:"text"},
        	...
        	matrixServerURL: {type:"text", required:true, value:"https://m.tekos.co"}
 		},
        inputs:0,
        outputs:1,
        icon: "matrix.png",
        label: function() {
            return this.name||"tekos bot";
        }
    });
</script>

<script type="text/x-red" data-template-name="tekos bot">
    <div class="form-row">
...
<script type="text/x-red" data-help-name="tekos bot">
    <p>To create a new tekos bot, you can use our  <a href="https://chat.tekos.co/#/user/@tekosapp:m.tekos.co" target="_blank">materbot</a> </p>
    <p>A configuration node that holds the details to connect to a Tekos chat server</p>
    <p>
        <ul>
            <li><code>User ID</code>: the user ID in the Matrix server, for instance @mybot:m.tekos.co</li>
            ...
            <li><code>Server URL</code>: URL of the Matrix homeserver, e.g. https://m.tekos.co</li>
...
<script type="text/javascript">
    RED.nodes.registerType('Tekos out',{
        category: 'Channels',
        color: '#a6bbcf',
        defaults: {
            name: { value: "" },
            bot: { value:"", type: "tekos bot", required: true }
        },
        inputs:1,
        outputs:0,
        icon: "matrix.png",
        label: function() {
            return this.name||"Tekos out";
        }
    });
</script>

<script type="text/x-red" data-template-name="Tekos out">
    <div class="form-row">
...
<script type="text/x-red" data-help-name="Tekos out">
    <p>An output Tekos node that sends a message to a chatroom.</p>
...
<script type="text/javascript">
    RED.nodes.registerType('Tekos in',{
        category: 'Channels',
        color: '#a6bbcf',
        defaults: {
            name: { value: "" },
        ...
        icon: "matrix.png",
        label: function() {
            return this.name||"Tekos in";
        }
    });
</script>

<script type="text/x-red" data-template-name="Tekos in">
    <div class="form-row">
        <label for="node-input-name"><i class="icon-tag"></i> Name</label>
        <input type="text" id="node-input-name" placeholder="Name">
    </div>
...
<script type="text/x-red" data-help-name="Tekos in">
    <p>An input Tekos node that outputs messages received in a chatroom.</p>
...
<script type="text/javascript">
    RED.nodes.registerType('Tekos command',{
        category: 'Channels',
        color: '#a6bbcf',
        defaults: {
            name: { value: "" },
        ...
        icon: "matrix.png",
        label: function() {
            return this.name||"Tekos command";
        }
    });
</script>

<script type="text/x-red" data-template-name="Tekos command">
    <div class="form-row">
        <label for="node-input-name"><i class="icon-tag"></i> Name</label>
        <input type="text" id="node-input-name" placeholder="Name">
    </div>
...
<script type="text/x-red" data-help-name="Tekos command">
    <p>An input Tekos node that triggers the output when a command is received from the chatroom.</p>
    <p>Outputs a message with the properties:
        <ul>
