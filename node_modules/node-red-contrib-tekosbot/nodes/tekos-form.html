...
<script type="text/x-red" data-help-name="form">
  <h3>Node Form</h3>
  <h6>Definitions</h6>
  <p>Displays form input into tekos bot messaging, and set up a new entry point to receive the submitted data</p>
  <h6>Pre conditions</h6>
  <p>To display the form into tekos bot, you need to follow the following steps</p>
  <ul>
      <li>1. Setting up tekos bot</li>
      <li>2. Link <b class="underline">tekos in</b> node before the form node</li>
      <li>3. Link <b class="underline">tekos out</b> node after the form node</li>
      <li>4. <i>Optional</i>: in tekos out config insert in the next listener input <b>chat/null</b></li> , this will make the postback of the submit button not related to your official tekos in, otherwise, if you like to detect if the user clicked on “cancel” you can add new tekos in listener (exp: chat/form/{id}/response) and insert the same listener path in your tekos out , see more about tekos out next listerner</li>
  ...
  <ul>
      <li>1. Insert new tekos in node with the <b>event: chat/FormId/{yourFormID}</b></li>
      <li>2. Insert a debug node to see your data</li>
      <li>3. Open <b class="underline">tekos bot <b class="underline"></li>
