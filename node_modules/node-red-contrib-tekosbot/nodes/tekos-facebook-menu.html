<script type="text/javascript">
  RED.nodes.registerType('tekos-facebook-menu', {
    category: 'Appearance',
    color: '#ffefe0',
    defaults: {
    ...
    inputs: 1,
    outputs: 1,
    paletteLabel: 'Facebook Persistent Menu',
    icon: 'chatbot-menu.png',
    label: function() {
      return this.name || 'Facebook Persistent Menu';
    },
    oneditsave: function() {
...
<script type="text/x-red" data-template-name="tekos-facebook-menu">
...
<script type="text/x-red" data-help-name="tekos-facebook-menu"><p>This node will set the persistent menu next to the editable area in Facebook Messenger, there two kind of options:</p>
<ul>
