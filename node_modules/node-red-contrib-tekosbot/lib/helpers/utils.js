...
module.exports = {
  ...
  isValidMessage: function(msg, node) {
    if (msg.originalMessage == null || msg.originalMessage.chatId == null || msg.originalMessage.transport == null) {
      ...
      console.log(lcd.grey('If you are receiving this it\'s likely because the flow is trying to start a conversation with'
        + ' the chatbot user without adding a "Conversatio node" at the beginning of the flow. Please read here:'));
      // eslint-disable-next-line no-console
      console.log('');
      // eslint-disable-next-line no-console
